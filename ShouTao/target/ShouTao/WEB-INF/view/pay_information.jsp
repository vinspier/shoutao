    ...
    <div>
        ...
        <form class="form-horizontal" style="margin-top:5px;margin-left:150px;">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="username" value="${order.address}" placeholder="收货地址">
                </div>
            </div>
            <div class="form-group">
                <label for="inputPassword3" class="col-sm-1 control-label">收货人</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputPassword3" value="${order.contactname}"
                           placeholder="收货人">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="confirmpwd" value="${order.telephone}"
                           placeholder="联系方式">
                </div>
            </div>
        </form>
